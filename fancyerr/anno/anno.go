...
func Anno(f *file.File, a Annotation) fancyerr.Annotation {
	c, h := a.Highlight(f)
	if a.Context != nil {
		c = a.Context(f, c, h)
	}
	return fancyerr.Annotation{
		File:         f,
...
func Range(f *file.File, start, end ast.Position, anno string) fancyerr.Annotation {
...
func ToEOL(f *file.File, start ast.Position, anno string) fancyerr.Annotation {
	return Anno(f, Annotation{
...
func FirstWord(f *file.File, start ast.Position, s, anno string) fancyerr.Annotation {
	return Anno(f, Annotation{
...
func Position(f *file.File, pos ast.Position, anno string) fancyerr.Annotation {
	return Anno(f, Annotation{
...
func NChars(f *file.File, start ast.Position, n int, anno string) fancyerr.Annotation {
	return Anno(f, Annotation{
...
// func Node(f *file.File, itm ast.Node, anno string) fancyerr.Annotation {
// 	return Anno(f, Annotation{
