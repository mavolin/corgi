...
func TestLexer_NextRuneWhile(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			Name:      "MatchesNot/matches rune",
			In:        "abc\ndef",
			Predicate: MatchesNot('\n', 'd'),
			Expect:    '\n',
			ExpectPos: 3,
		},
		{
			Name:      "MatchesNot/encounters eof",
			In:        "abcdef",
			Predicate: MatchesNot('g'),
			Expect:    EOF,
			ExpectPos: 6,
		},
	}
...
func TestLexer_IgnoreRunesWhile(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			Name:      "MatchesNot/immediate stop",
			In:        "abc",
			Predicate: MatchesNot('a'),
			ExpectPos: 0,
		},
		{
			Name:      "MatchesNot/skip some",
			In:        "ababbc",
			Predicate: MatchesNot('c'),
			ExpectPos: 5,
		},
		{
			Name:      "MatchesNot/eof",
			In:        "abcbac",
			Predicate: MatchesNot('d'),
			ExpectPos: 6,
		},
	}
