...
func (loader *importLoader) loadImport(ctx context.Context, f *file.File, imp *file.Import) {
	...
	cycle := loader.graph.AddImport(loader.l.Pkg, imp.CorgiPath, func() (*file.Package, diagnostic.List, error) {
...
func (loader *importLoader) loadBuiltin(ctx context.Context) {
	...
	} else if loader.l.Pkg.CorgiImportPath == loader.l.builtinPath {
	...
	cycle := loader.graph.AddImport(loader.l.Pkg, loader.l.builtinPath, func() (*file.Package, diagnostic.List, error) {
		return loader.l.importer(ctx, loader.l.builtinPath)
	})
	if cycle != nil {
		loader.reportImportCycle(logger, loader.l.Pkg.Files[0], nil, cycle)
		return
	}
